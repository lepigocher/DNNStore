...
<div id="divControls" runat="server" class="StoreAccountWrapper">
    ...
    <div class="StoreAccount-Footer">
        <asp:LinkButton ID="StoreAccountContinueShopping" runat="server" CausesValidation="false" CssClass="CommandButton" resourcekey="ContinueShopping" onclick="StoreAccountContinueShopping_Click">Continue Shopping</asp:LinkButton>
    </div>
</div>
