...
<table width="100%" border="0" cellspacing="5">
    ...
    <tr id="trSEOName" runat="server" valign="top">
        ...
        <td class="Normal">
            ...
            <asp:linkbutton id="cmdSuggest" CssClass="CommandButton" runat="server" CausesValidation="false" BorderStyle="None" resourcekey="cmdSuggest" onclick="cmdSuggest_Click">Suggest</asp:linkbutton>
