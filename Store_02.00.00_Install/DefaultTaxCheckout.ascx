<%@ Control language="c#" CodeBehind="DefaultTaxCheckout.ascx.cs" Inherits="DotNetNuke.Modules.Store.Providers.Tax.DefaultTaxProvider.DefaultTaxCheckout" AutoEventWireup="True" %>
