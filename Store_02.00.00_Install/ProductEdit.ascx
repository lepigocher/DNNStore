    ...
    <tbody>
        ...
        <tr id="trSEOName" runat="server" valign="top">
            ...
            <td>
                ...
                <asp:linkbutton id="cmdSuggest" CssClass="CommandButton" runat="server" CausesValidation="false" BorderStyle="None" resourcekey="cmdSuggest">Suggest</asp:linkbutton>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox id="txtRegularPrice" Runat="server" Width="100" MaxLength="25" CssClass="NormalTextBox"></asp:TextBox>
                <asp:RequiredFieldValidator id="valRequireRegularPrice" runat="server" ControlToValidate="txtRegularPrice" ErrorMessage="* Regular price is required." resourcekey="valRequireRegularPrice" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator>
                <asp:CompareValidator id="valRegularPrice" runat="server" ErrorMessage="Error! Please enter a valid price." resourcekey="valRegularPrice" Type="Currency" ControlToValidate="txtRegularPrice" Operator="DataTypeCheck" Display="Dynamic" SetFocusOnError="True"></asp:CompareValidator>
            </td>
        </tr>
        <tr>
            <td class="SubHead">
