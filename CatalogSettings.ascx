...
<table id="tblGenSettings" runat="server" style="text-align:left;" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr id="trDisplayAllProducts" runat="server">
        <td class="SubHead">
        ...
        <td>
            <asp:checkbox id="chkDisplayAllProducts" runat="server" CssClass="NormalTextBox"></asp:checkbox>
        </td>
    </tr>
    <tr>
        <td class="SubHead">
...
<table id="tblNewProductList" runat="server" style="text-align:left;" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td>
            <asp:checkbox id="chkNPLDisplayByCategory" runat="server" CssClass="NormalTextBox"></asp:checkbox>
        </td>
    </tr>
    <tr>
        <td class="SubHead">
...
<table id="tblFeaturedProductList" runat="server" style="text-align:left;" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td>
            <asp:checkbox id="chkFPLDisplayByCategory" runat="server" CssClass="NormalTextBox"></asp:checkbox>
        </td>
    </tr>
    <tr>
        <td class="SubHead">
