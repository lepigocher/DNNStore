...
<table id="tbAddress" runat="server" class="StoreAccountAddress">
	...
	<tr id="rowUnit" runat="server">
		...
		<td class="StoreAddressField">
		    ...
		    <asp:requiredfieldvalidator id="valUnit" runat="server" CssClass="NormalRed" ControlToValidate="txtUnit" ErrorMessage="* Unit is required." Display="Dynamic" resourcekey="UnitRequired" SetFocusOnError="True"></asp:requiredfieldvalidator>
		</td>
	</tr>
	...
	<tr id="rowRegion" runat="server">
		...
		<td class="StoreAddressField">
			...
			<asp:requiredfieldvalidator id="valRegion1" runat="server" CssClass="NormalRed" ControlToValidate="cboRegion" InitialValue="-1" ErrorMessage="* County required." Display="Dynamic" SetFocusOnError="True"></asp:requiredfieldvalidator>
	...
	<tr id="rowEmail" runat="server">
		...
		<td class="StoreAddressField">
            ...
            <asp:CustomValidator ID="valCustEmail" runat="server" CssClass="NormalRed" ControlToValidate="txtEmail" onservervalidate="valCustEmail_ServerValidate" ErrorMessage="* Email is not valid." Display="Dynamic" resourcekey="EmailInvalid" SetFocusOnError="True"></asp:CustomValidator>
		</td>
	</tr>
