...
<fieldset ID="fsShippingAddress" class="StoreAccountCheckoutShippingAddress" runat="server">
    ...
    <table class="StoreAccountCheckoutSelectShippingAddress">
	    <tr>
		    ...
		    <td>
			    <asp:radiobutton id="radNone" tabIndex="20" runat="server" autopostback="True" groupname="radShipAddress" oncheckedchanged="radNone_CheckedChanged"></asp:radiobutton>
			    <dnn:label id="lblNone" controlname="radNone" runat="server"></dnn:label>
