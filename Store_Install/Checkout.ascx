    ...
    <asp:placeholder id="plhCheckout" runat="server">
        ...
        <div id="divStoreCheckoutCart" runat="server" class="StoreAccountCheckoutCart">
            <div class="StoreAccountCheckoutTotal">
                ...
                <table id="tbDiscount" runat="server" class="StoreAccountCheckoutCart">
                    <tr>
                        <td class="StoreAccountCheckoutCartFooter">
                            <dnn:label id="lblCartDiscount" runat="server" controlname="lblDiscount"></dnn:label>
                        </td>
                        <td class="StoreAccountCheckoutCartDiscount">
                            <asp:Label ID="lblDiscount" runat="server" CssClass="StoreAccountCheckoutDiscount"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <div id="divStoreCheckoutCoupon" runat="server" class="StoreAccountCheckoutCoupon">
                <table>
                    <tr>
                        <td>
                            <dnn:label ID="lblCouponCode" runat="server" controlname="txtCouponCode"></dnn:label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCouponCode" runat="server" CssClass="NormalTextBox StoreAccountCheckoutCouponCode"></asp:TextBox>
                            <asp:LinkButton ID="lbApplyCoupon" runat="server" OnClick="lbApplyCoupon_Click" CausesValidation="false" CssClass="dnnSecondaryAction" resourcekey="ApplyCoupon">Apply</asp:LinkButton>
                            <asp:Label ID="lblDiscountMessage" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="StoreAccountCheckoutNavigation">
            <ul class="StoreAccountCheckoutNavButtons">
                <li id="StoreCheckoutNavPrevious" runat="server">
                    <asp:LinkButton ID="StoreAccountCheckoutPrevious" runat="server" CausesValidation="false" OnClick="StoreAccountCheckoutPrevious_Click" CssClass="dnnSecondaryAction" resourcekey="Back">Previous</asp:LinkButton>
                </li>
                <li id="StoreCheckoutNavNext" runat="server">
                    <asp:LinkButton ID="StoreAccountCheckoutNext" runat="server" CausesValidation="true" OnClick="StoreAccountCheckoutNext_Click" CssClass="dnnPrimaryAction" resourcekey="Continue">Next</asp:LinkButton>
                </li>
            </ul>
        </div>
    </asp:PlaceHolder>
