...
<table cellpadding="0" cellspacing="0" width="100%" border="0" class="StoreAdmin">
    <tr>
        ...
        <td align="right">
            ...
            <asp:PlaceHolder ID="plhCoupons" runat="server" Visible="false">
                <asp:label id="lblSpacer5" cssclass="Normal" runat="server">&nbsp;|&nbsp;</asp:label>
                <asp:linkbutton id="btnCoupons" cssclass="Normal" runat="server" resourcekey="btnCoupons" CausesValidation="false" OnClick="btnCoupons_Click">Coupons</asp:linkbutton>
            </asp:PlaceHolder>
            <asp:label id="lblSpacer6" cssclass="Normal" runat="server" Visible="False">&nbsp;|&nbsp;</asp:label>
