...
<div id="divControls" runat="server" class="StoreMiniCartWrapper">
    ...
    <p id="phlViewCart" runat="server">
        <asp:linkbutton id="btnViewCart" runat="server" cssclass="dnnPrimaryAction StoreMiniCartViewCart" resourcekey="btnViewCart" OnClick="btnViewCart_Click">View Cart Details</asp:linkbutton>
    </p>
</div>