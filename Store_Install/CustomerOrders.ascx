...
<asp:Panel id="pnlOrdersError" runat="server">
    <div class="dnnFormMessage dnnFormWarning"><asp:label id="lblError" runat="server" CssClass="StoreAccountOrdersError"></asp:label></div>
</asp:Panel>
<asp:Panel ID="pnlOrders" runat="server" CssClass="dnnForm StoreAccountOrdersWrapper">
    <asp:placeholder id="plhGrid" runat="server">
        <fieldset>
            <div class="dnnFormItem">
                <asp:datagrid id="grdOrders" runat="server" showheader="true" showfooter="false" autogeneratecolumns="false" CssClass="StoreAccountOrders dnnGrid">
                    <HeaderStyle CssClass="dnnGridHeader StoreAccountOrdersHeader" />
                    <ItemStyle CssClass="dnnGridItem StoreAccountOrdersItem" />
                    <AlternatingItemStyle CssClass="dnnGridAltItem StoreAccountOrdersAlternatingItem" />
                    <columns>
                        ...
                        <asp:TemplateColumn HeaderStyle-CssClass="StoreAccountOrdersEditHeader" ItemStyle-CssClass="StoreAccountOrdersEdit">
                            ...
                            <ItemTemplate>
                                <asp:hyperlink id="lnkEdit" runat="server" resourcekey="lnkEdit" CssClass="dnnPrimaryAction StoreAccountOrdersEditButton">Details</asp:hyperlink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-CssClass="StoreAccountOrdersCancelHeader" ItemStyle-CssClass="StoreAccountOrdersCancel">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton id="lnkCancel" runat="server" resourcekey="lnkCancel" CssClass="dnnSecondaryAction StoreAccountOrdersCancelButton">Cancel</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </columns>
                </asp:datagrid>
    ...
    <asp:placeholder id="plhForm" runat="server" visible="false">
        <h2 class="dnnFormSectionHead"><asp:label id="lblEditTitle" runat="server" resourcekey="lblEditTitle" class="StoreAccountOrderTitle">Order Details</asp:label></h2>
                    ...
                    <table class="StoreAccountOrderHeader">
                        ...
                        <tr>
                            ...
                            <td class="StoreAccountOrderHeaderStatusButtons">
                                <asp:Button ID="btnPayNow" runat="server" resourcekey="btnPayNow" Text="Pay Now!" CssClass="dnnPrimaryAction" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Button id="btnCancel" runat="server" resourcekey="btnCancel" Text="Cancel Order" CssClass="dnnSecondaryAction" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="dnnFormItem">
                    <table class="StoreAccountOrderFooter">
                        <tr id="trTotal" runat="server">
                            ...
                            <td class="StoreAccountOrderFooterValue StoreAccountOrderFooterTotal">
                                <asp:Label id="lblTotal" runat="server" EnableViewState="false"></asp:Label>
                            </td>
                        </tr>
                        <tr id="trDiscount" runat="server">
                            <td class="StoreAccountOrderFooterHeader">
                                <asp:Label id="lblDiscountTag" Runat="server" resourcekey="lblDiscountTag">Discount:</asp:Label>
                            </td>
                            <td class="StoreAccountOrderFooterValue StoreAccountOrderFooterDiscount">
                                <asp:Label id="lblDiscount" runat="server" EnableViewState="false"></asp:Label>
                            </td>
                        </tr>
                        <tr id="trShipping" runat="server">
                            ...
                            <td class="StoreAccountOrderFooterValue StoreAccountOrderFooterShipping">
                        ...
                        <tr id="trTax" runat="server">
                            ...
                            <td class="StoreAccountOrderFooterValue StoreAccountOrderFooterTax">
                        ...
                        <tr>
                            ...
                            <td class="StoreAccountOrderFooterValue StoreAccountOrderFooterGrandTotal">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <asp:LinkButton id="lnkbtnSave" runat="server" resourcekey="lnkbtnSave" CssClass="dnnPrimaryAction StoreAccountOrderHeaderButtonSave">Save</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                        ...
                        <tr>
                            <td class="StoreAccountOrderFooterBack" colspan="2">
                                <asp:Button ID="btnBack" runat="server" resourcekey="btnBack" Text="&nbsp;&lt;&lt;&nbsp;" CssClass="dnnSecondaryAction" />
                            </td>
                        </tr>
                    </table>
                </div>
