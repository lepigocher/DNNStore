...
<p class="StoreAddReview"><asp:linkbutton id="btnAddReview" CssClass="dnnSecondaryAction" Text="Add Review" resourcekey="AddReview" runat="server" onclick="btnAddReview_Click"></asp:linkbutton></p>
